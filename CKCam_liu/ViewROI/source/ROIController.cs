...
namespace ViewROI
{
	...
	public class ROIController
	{
        ...
        public  void removeROI(ref System.Collections.Generic.List<ROI> roi)
        {
            if (roi == null)
                return;
            this.activeROIidx = 0;
            ...
            foreach (var roi in rois)
            {
                ...
                switch (roi.Type)
                {
                    case "ROIRectangle1":
                        ...
                        if (m_roiData != null)
                        {
                            displayRect1(roi.Color, m_roiData[0].D, m_roiData[1].D, m_roiData[2].D, m_roiData[3].D);
                        }
                        break;
                    case "ROIRectangle2":
                        ...
                        if (m_roiData != null)
                        {
                            displayRect2(roi.Color, m_roiData[0].D, m_roiData[1].D, m_roiData[2].D, m_roiData[3].D, m_roiData[4].D);
                    ...
                    case "ROICircle":
                        ...
                        if (m_roiData != null)
                        {
                           displayCircle(roi.Color, m_roiData[0].D, m_roiData[1].D, m_roiData[2].D);
                        }
                        break;
                    case "ROILine":
                        ...
                        if (m_roiData != null)
                        {
                            displayLine(roi.Color, m_roiData[0].D, m_roiData[1].D, m_roiData[2].D, m_roiData[3].D);
                        }
                        break;
                    default:
                        break;
