...
namespace ViewROI
{
	...
	public class HWndCtrl
	{
        ...
        public  HWndCtrl(HWindowControl view, Label location_point)
        {
            viewPort = view;
        ...
        /// <param name="r2">y coordinate of right lower corner</param>
        /// <param name="c2">x coordinate of right lower corner</param>
        private void setImagePart1(int r1, int c1, int r2, int c2)
        {
            ImgRow1 = r1;
            ImgCol1 = c1;
            ImgRow2 = imageHeight = r2;
            ...
            rect.Width = (int)imageWidth;
          //  HTuple hv_rate;
          //  HOperatorSet.TupleMin2(1.0 * (viewPort.Size.Width) / imageWidth, 1.0 * (viewPort.Size.Height) / imageHeight, out hv_rate);
         //   HOperatorSet.ZoomImageFactor(image, out out_image, hv_rate, hv_rate, "constant");
            rect.X = (int)ImgCol1;
            rect.Y = (int)ImgRow1;
           ImgRow2 =  rect.Height = (int)viewPort.Size.Height;
           ImgCol2 = rect.Width = (int)viewPort.Size.Width;
            viewPort.ImagePart = rect;
        }

        private void setNewImage(HImage image, out HObject out_newimage,int w,int h)
        {
            HTuple hv_rate;
            HOperatorSet.TupleMin2(1.0 * (viewPort.Size.Width) / w, 1.0 * (viewPort.Size.Height) / h, out hv_rate);
            HOperatorSet.ZoomImageFactor(image, out out_newimage, hv_rate, hv_rate, "constant");
            hv_scale = hv_rate;
		...
		public void resetAll()
		{
			ImgRow1 = 0;
			ImgCol1 = 0;
            ImgRow2 = (int)viewPort.Size.Height;
            ImgCol2 = (int)viewPort.Size.Width;
			...
			rect.X = (int)ImgCol1;
			rect.Y = (int)ImgRow1;
			rect.Width = (int)viewPort.Size.Width;
			rect.Height = (int)viewPort.Size.Height;
			viewPort.ImagePart = rect;
